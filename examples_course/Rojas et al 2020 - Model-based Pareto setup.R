...
# Content:   Data generating process for setting pareto (Rojas-Perilla et al. 2020)
#########################################################################
rm(list=ls())
...
# Pareto setup compare Rojas-Perilla et al. (2020) Table 6 
...
# save(Pop, file = "Setting3_Pareto_500.RData")